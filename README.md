...
> **当前版本：v0.1.0** — 首个可用版本 | [变更日志](CHANGELOG.md) | [路线图](docs/roadmap.md) | [已知问题](docs/known_issues.md)
...
- 687 个 pytest 测试、73 项集成测试、15 个 Streamlit smoke tests
...
v0.1.0 已打通完整链路，但 UI 体验、报告模板可配置化、中文文献导入、图表导出增强等会在后续版本继续改进。
